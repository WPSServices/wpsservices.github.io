    ...
    <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white py-24 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center md:gap-12 lg:gap-16">
          ...
          <div className="flex-1 mt-10 md:mt-0 flex md:justify-center md:pl-8">
            <img
              src="/images/welding.png"
              alt="Welder at work with sparks"
              className="w-full h-auto max-w-md lg:max-w-lg rounded-lg shadow-xl border"
              style={{ borderColor: 'var(--color-blue-300)', borderWidth: 'medium' }}
            />
          </div>
        </div>
      </div>
